      ...
      <main className="flex-1 pb-24 px-6">
        <div className="max-w-6xl mx-auto flex gap-10 items-start">
          ...
          <aside className="hidden lg:block w-64 shrink-0 sticky top-24 self-start">
            <Card className="bg-[#111113] border border-white/[0.07] rounded-2xl p-4 gap-0 shadow-none">
          ...
          <div className="flex-1 min-w-0 space-y-10">
            ...
            <motion.div {...fadeUp} className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                <div key={label} className="p-4 rounded-xl bg-[#111113] border border-white/[0.07] text-center">
                  <div className="w-9 h-9 rounded-xl bg-[#f5a623]/[0.08] border border-[#f5a623]/15 flex items-center justify-center mx-auto mb-3">
                    <Icon size={16} className="text-[#f5a623]" />
                  </div>
            ...
            <SectionBlock id="overview" icon={Shield} title="1. Tổng quan">
              ...
              <div className="p-4 rounded-xl bg-emerald-500/[0.05] border border-emerald-500/15 flex items-start gap-3">
            ...
            <SectionBlock id="voice" icon={Eye} title="3. Dữ liệu giọng nói & AI">
              ...
              <div className="p-4 rounded-xl bg-amber-500/[0.05] border border-amber-500/15 flex items-start gap-3">
