...
const Success = () => {
  ...
  const mcName = mc?.name || (mcId ? "Loading MC..." : "MC");
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="space-y-2">
          <h1 className="text-4xl font-bold text-white tracking-tight">
            Stage is <span className="text-[#f5a623]">Set!</span>
          </h1>
          <p className="text-zinc-400 text-[15px] leading-relaxed max-w-xl mx-auto">
            Booking Request Successfully Transmitted. Your funds are secured in MCHub Escrow vault.
          </p>
        </div>
        ...
        <div className="bg-[#111113] border border-white/[0.07] rounded-2xl p-6 mt-8 flex flex-col md:flex-row gap-8 items-center text-left">
          <div className="flex items-center gap-4 md:border-r md:border-white/[0.07] md:pr-8">
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-500 flex items-center gap-1 mt-0.5">
                <ShieldCheck size={10} className="text-[#f5a623]" /> Platinum Elite MC
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-1 flex-wrap gap-6 justify-center md:justify-start">
            <div>
              <span className="text-[10px] text-zinc-600 uppercase tracking-wider block mb-1">Session Date</span>
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 text-emerald-400 text-[13px] font-medium">
                <ShieldCheck size={13} /> Funds Secured
              </div>
            </div>
            <div>
              <span className="text-[10px] text-zinc-600 uppercase tracking-wider block mb-1">Tracking ID</span>
        ...
        <div className="flex flex-col md:flex-row gap-3 justify-center pt-4">
          ...
          >
            Message {mc?.name || "MC"} <MessageCircle size={16} className="text-[#f5a623]" />
          </button>
          <button
          ...
          >
            Go to Dashboard <Zap size={16} fill="currentColor" />
          </button>
        </div>
        ...
        <div className="flex justify-center gap-8 pt-8 text-zinc-700">
          {[
            ...
            { icon: Briefcase, text: "Career Roadmap Ready" },
          ].map(({ icon: Icon, text }) => (
